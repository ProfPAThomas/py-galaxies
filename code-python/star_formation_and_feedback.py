...
def F_gal_SNR_feedback(mass_stars,gal,sub,halo,parameters):
   ...
   if snr_model == "Hen15":
      ...
      mass_reheat, mass_eject_max = F_SNR_feedback_Hen15(mass_stars,sub.half_mass_virial_speed,gal['mass_gas_cold'],parameters)
   else:
   ...
   mass_eject=min(mass_eject_max,sub.mass_gas_hot.copy())
...
def F_SNR_feedback_Hen15(mass_stars,v_vir,mass_gas_cold,parameters):
   ...
   epsilon_feedback = parameters.Hen15_eta*(0.5+(parameters.Hen15_v_eject_internal/v_vir)**parameters.Hen15_beta2)
